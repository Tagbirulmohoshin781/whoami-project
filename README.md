...
<p align="center">
  <a href="https://github.com/Tagbirulmohoshin781/whoami-project/issues/new?labels=enhancement&template=feature_request.md&title=Feature+Request">Feature Request</a> |
  <a href="https://github.com/Tagbirulmohoshin781/whoami-project/issues/new?labels=bug&template=bug_report.md&title=Bug">Report a Bug</a>
</p>

<p align="center">
  <a href="https://github.com/Tagbirulmohoshin781/whoami-project/releases">
    <img src="https://img.shields.io/github/v/release/Tagbirulmohoshin781/whoami-project?color=black&style=for-the-badge" alt="Release">
  </a>
  <a href="https://github.com/Tagbirulmohoshin781/whoami-project/blob/main/LICENSE">
    <img src="https://img.shields.io/github/license/Tagbirulmohoshin781/whoami-project?color=black&style=for-the-badge" alt="License">
  </a>
  <a href="https://github.com/Tagbirulmohoshin781/whoami-project">
    <img src="https://img.shields.io/github/languages/code-size/Tagbirulmohoshin781/whoami-project?color=black&style=for-the-badge" alt="Code Size">
  </a>
  <a href="https://github.com/Tagbirulmohoshin781/whoami-project/commits">
    <img src="https://img.shields.io/github/last-commit/Tagbirulmohoshin781/whoami-project?color=black&style=for-the-badge" alt="Last Commit">
  </a>
</p>
...
```bash
# Debian / Kali / Ubuntu:
sudo apt update && sudo apt install tar tor curl python3 python3-scapy network-manager iptables

# Arch Linux:
sudo pacman -S tar tor curl python python-scapy networkmanager iptables
```
...
1. Clone the repository:
   ```bash
   git clone https://github.com/Tagbirulmohoshin781/whoami-project
   ```
...
|--------------------|-------|--------------------------------------------|
| `--start`          | `-s`  | Makes backups and starts selected modules. |
| `--stop`           | `-k`  | Closes active modules and restores backups.|
| `--status`         | `-t`  | Displays current working status & Tor IP.  |
| `--fix`            | `-f`  | Repairs the system in case of an issue.    |
| `--help`           | `-h`  | Shows the help menu with all commands.     |
